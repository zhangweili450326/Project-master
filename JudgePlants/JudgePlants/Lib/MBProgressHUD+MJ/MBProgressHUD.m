...
- (void)layoutSubviews {
    ...
    CGSize labelSize=[label.text boundingRectWithSize:CGSizeMake(maxWidth, MAXFLOAT) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:kLabelFontSize]} context:nil].size;
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    if ([detailsLabel.text respondsToSelector: @selector(boundingRectWithSize:options:attributes:context:)] == YES) {
        size = [detailsLabel.text boundingRectWithSize: maxSize options: NSStringDrawingUsesLineFragmentOrigin
